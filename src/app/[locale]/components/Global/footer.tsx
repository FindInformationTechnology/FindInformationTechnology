...
export default function Footer() {
  ...
  return (
    <>
      {pathname && pathname === "/en/my_account" ? (
        <div className="bg-[#F0F0F0] w-full flex items-center justify-center py-4 gap-3">
          <span className="text-[12px] text-center md:text-[14px] font-normal cursor-pointer hover:underline">Advertising options</span>
          <span className="text-[12px] text-center md:text-[14px] font-normal cursor-pointer hover:underline">Advertising options</span>
          <span className="text-[12px] text-center md:text-[14px] font-normal cursor-pointer hover:underline">Advertising options</span>
          <span className="text-[12px] text-center md:text-[14px] font-semibold">  © 2024 Find.in.te </span>
        </div>
      ) : (
        <footer className="">
          {/* MD LG XL Desktop */}

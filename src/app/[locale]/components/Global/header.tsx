...
import Map from "../../../../../public/Mapjs.png";
    ...
    <Disclosure as="nav" className="z-40 fixed top-0 min-w-full max-w-full">
      {({ open }) => (
              ...
              <nav className="hidden lg:block header-wrapper p-0 m-0">
                <div className="wrapper main-nav p-[1rem] m-0">
                  <div className="left-side flex gap-6">
                    ...
                    {/* Change Location Side Map Modal */}
                    {modalShow && modalShow == true && (
                      <div className="z-50 fixed top-0 left-0 bg-[#0a16347f] min-w-full min-h-screen flex items-start justify-start">
                        <div className="relative flex flex-col items-start justify-start min-h-screen max-h-screen min-w-[32vw] max-w-[32vw] bg-[#fff]">
                          <div className="flex items-center justify-between min-w-full max-w-full p-3">
                          ...
                          <div className="flex min-w-full max-w-full">
                            {/* <Map address="73 Financial Center Road, Downtown Dubai" /> */}
                            <Image
                              src={Map}
                              className="min-w-full max-h-[70vh]"
                              alt="map"
                            />
                          </div>
                          <div className="flex min-w-full max-w-full flex-col items-start justify-start gap-1 p-3">
                            <span className="text-[20px] text-black font-semibold">
                              Specific location
                            </span>
                            <span className="text-[14px] text-black font-light">
                              73 Financial Center Road, Downtown Dubai
                            </span>
                    ...
                    {/* Log Out Modal */}
                    {logOutModal && (
                      <div className="z-2 0 fixed top-0 start-0 w-full h-full before:absolute before:top-0 before:start-0 before:h-full before:w-full before:bg-slate-700/40">
        ...
        onToggle={handleToggle}
                      >
                        <NavDropdown.Item
                          href={`${pathname.slice(0, 3)}/my_account`}
                          className="p-0 pt-3"
                        >
                        ...
                        <NavDropdown.Item
                          href="#action/3.1"
                          className="p-0 pt-2 min-w-full"
                        >
                          <div className="flex items-center gap-2 w-full border-b-[.5px] border-b-[#CBCBCB] pb-2 px-3">
                            <Image
                              src={MyPremiumSubscriptionIcon}
                              width={22}
                              height={22}
                              alt="icon"
                            />
                            <span className="text-[14px] font-medium">
                              {t("MyPremiumSubscription")}
                            </span>
                          </div>
                        </NavDropdown.Item>
                        <div
                          onClick={() => handleLogoutClick()}
                          className="flex items-center justify-center text-center gap-1 py-2 px-3 border-[#2C6FF4] border-[.5px] rounded-[8px] my-3 mx-3 cursor-pointer"
                        >
                          <Image
                            src={LogoutIcon}
                            width={24}
                            ...
                            alt="icon"
                          />
                          <span className="text-[12px] font-medium text-[#2C6FF4]">
                            {t("LogOut")}
                          </span>
                        </div>
                      </NavDropdown>
                    ...
                    <div className="notification-dropdown-wrapper">
                      ...
                      >
                        <NavDropdown.Item
                          href={`${pathname.slice(0, 3)}/seller_profile`}
                          className="p-0 pt-2 min-w-full"
                        >
                          <div className="flex items-center justify-between px-3 gap-2 w-full border-b-[.5px] border-b-[#CBCBCB] pb-2  min-w-full">
                            <div className="flex items-center justify-center text-center gap-1">
                              ...
                              <div className="flex items-center justify-center bg-[#F19371] p-2 rounded-full h-[2rem] w-[2rem] mx-auto text-center font-semibold">
                                2
                              </div>
                            </div>
                            <span className="text-light text-[14px] text-black">
                              {t("ReadAll")}
                            </span>
                          </div>
                        </NavDropdown.Item>
                        ...
                        <div className="no-notification-wrapper min-h-[55vh] w-full flex flex-col items-center justify-center gap-2 mx-auto p-5">
                          ...
                          <span className="font-normal text-[16px]">
                            {t("WeWillTellYouWhenThereIsAnUpdate")}
                          </span>
                        </div>
                      </NavDropdown>
                    </div>
